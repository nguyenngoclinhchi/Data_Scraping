...
def print_details(country_name, link, country_macro_ent, source):
    ...
    print(country_obj.country_name, country_obj.code, country_obj.date, country_obj.value, country_obj.link, country_obj.id,
          country_obj.source)
            ...
            if status == 'Failed':
                ...
                if status_new == "All":
                    ...
                    for tr in tr_list:
                        ...
                        print(detail)
                        if detail.__len__() == 2:
                            non_trading_countries.append(detail[-1])
                        del detail
